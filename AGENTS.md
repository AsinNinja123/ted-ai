...
## Current state — read from the repo on Friday August 14, 2026
...
| Memory | 25 facts, ~550 chat turns, 5 session memories |
| Tests | 479 checks across 16 suites |
...
- **Data nothing reads.** patterns has 124 rows and nothing in the code reads it. Either use it or drop it.
