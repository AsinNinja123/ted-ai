...
## Current state — read from the repo on Wednesday September 2, 2026
...
| Memory | 58 facts, ~1700 chat turns, 11 session memories |
| Tests | 1252 checks across 37 suites |
...
- **Empty tables.** bouncer_rules, bouncer_state, goals, habit_logs, news_items, news_topics, relationship_memory, routines — built and never used, or left over from a deleted feature.
