...
## Current state — read from the repo on Tuesday August 25, 2026
...
| Tests | 1203 checks across 36 suites |
...
- **Empty tables.** active_tasks, bouncer_rules, bouncer_state, goals, habit_logs, news_items, news_topics, relationship_memory, routines, task_events, turn_interpretations — built and never used, or left over from a deleted feature.
