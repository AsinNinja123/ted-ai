...
## Current state — read from the repo on Friday September 4, 2026
...
| Memory | 58 facts, ~1750 chat turns, 12 session memories |
| Tests | 1357 checks across 38 suites |
| Calendar daemon | running |

**Standing issues, detected not remembered:**

- **Empty tables.** goals, habit_logs, news_items, news_topics — built and never used, or left over from a deleted feature.
