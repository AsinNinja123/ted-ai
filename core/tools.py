...
TOOL_SCHEMAS = [
    ...
    # "tell me when something happens".
    {
        ...
        "function": {
            "name": "news_watch",
            "description": (
                "Start monitoring a subject so Ted checks it in the background and "
                "reports new stories. Use when the user says watch/monitor/keep me "
                "posted/let me know about. For a one-off question use web_search instead."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "label": {"type": "string",
                              "description": "Short name, e.g. 'AI models' or 'Rust'"},
                    "query": {"type": "string",
                              "description": "Search terms to watch for. Defaults to "
                                             "the label."},
                    "sources": {"type": "string",
                                "description": "'hn,web' (default), 'hn' for Hacker "
                                               "News only, or 'web' for news sites only"}
                },
                "required": ["label"]
            }
        }
    },
    {
        ...
        "function": {
            "name": "news_latest",
            "description": (
                "Report new stories found for the monitored subjects. Checks live "
                "first, so it is current. Use for 'what's new', 'any news on X', "
                "'catch me up'."
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "topic": {"type": "string",
                              "description": "Optional: only this watched subject"},
    ...
    },
    {
        ...
        "function": {
            "name": "news_topics",
            "description": "List what Ted is currently monitoring, and when each was "
                           "last checked.",
            "parameters": {"type": "object", "properties": {}, "required": []}
        }
    },
    {
        ...
        "function": {
            "name": "news_unwatch",
            "description": "Stop monitoring a subject and forget its stored stories.",
            "parameters": {
                "type": "object",
                "properties": {
                    "label": {"type": "string", "description": "The watched subject"}
                },
                "required": ["label"]
            }
        }
