...
def render_markdown(d: dict) -> str:
    ...
    Same facts, shaped for whichever assistant reads the repo next. This is the
    part that kept going stale by hand.
    """
    ...
    L.append(f"<!-- Regenerate: python tools/ted_map.py --markdown -->")
    L.append("")
    L.append(f"## Current state — read from the repo on {d['generated']}")
    L.append("")
    L.append("| | |")
    L.append("|---|---|")
